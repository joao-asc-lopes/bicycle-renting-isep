...
public class VertexTest {
    ...
    Vertex<String, Integer> instance2 = new Vertex<>();
    ...
    @Test
    public void ensureVertexSameHashCodes(){
        boolean expected = true;
        boolean flag = this.instance.equals(this.instance);
        assertEquals(expected,flag);
    }
    @Test
    public void ensureVertexSameHashCodesDifferent(){
        boolean expected = false;
        this.instance2.setKey(991);
        boolean flag = this.instance.equals(this.instance2);
        assertEquals(expected,flag);
    }
    @Test
    public void ensureConstructorCopyWorks(){
        this.instance.setKey(21);
        Vertex<String, Integer> instance3 = new Vertex<>(this.instance);
        int keyExpected = 21;
        int keyResult = instance3.getKey();
        assertEquals(keyExpected,keyResult);
